...
public class Medico {
	...
	public Medico(Long id, String nombres, String primerApellido, String segundoApellido, String area, Byte genero,
			Long telefono, String correo, String usuario, String contraseña) {
		super();
		this.id = id;
	...
	@Override
	public int hashCode() {
		return Objects.hash(area, contraseña, correo, genero, id, nombres, primerApellido, segundoApellido, telefono,
				usuario);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(area, other.area) && Objects.equals(contraseña, other.contraseña)
				&& Objects.equals(correo, other.correo) && Objects.equals(genero, other.genero)
	...
	public String toString() {
		return "Medico [id=" + id + ", nombres=" + nombres + ", primerApellido=" + primerApellido + ", segundoApellido="
				...
				+ correo + ", usuario=" + usuario + ", contraseña=" + contraseña + "]";
	}
